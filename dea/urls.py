...
urlpatterns = [
    ...
    path('account/accountstatement/create/',views.AccountStatementCreateView,name = 'dea_accountstatement_create'),
    ...
    path('ledger/ledgerstatement/create/',views.LedgerStatementCreateView,name = 'dea_ledgerstatement_create'),
    path('accounts/<int:pk>/mock_pledge_loan',views.mock_pledge_loan,name="dea_pledge_loan"),
    path('accounts/<int:pk>/mock_repay_loan/',views.mock_repay_loan,name='dea_repay_loan'),
